...
function getDirents(path) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        fs__namespace.readdir(path, options, function (error, dirents) {
            if (error) {
...
function resolvePath() {
    ...
    return path__default['default'].resolve.apply(path__default['default'], __spreadArray([process.cwd()], segments));
}
...
function readFileLineByLine(path, onLine) {
    return new Promise(function (resolve, reject) {
        var file = readline__default['default'].createInterface({
            input: fs__default['default'].createReadStream(resolvePath(path), {
                flags: 'r',
                encoding: ENCODING,
            }),
            terminal: false,
